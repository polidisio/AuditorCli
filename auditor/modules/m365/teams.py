    ...
    try:
        ...
        if allow_external is True:
            ...
            findings.append(Finding(
                ...
                mitre_id=(_c.mitre_id if _c else None) or "T1566.003",
    ...
    try:
        ...
        if public_teams:
            ...
            findings.append(Finding(
                ...
                remediation=(_c.remediation if _c else None) or "Review public teams. Set sensitive teams to Private. Consider HiddenMembership for leadership teams.",
            ))
    ...
    try:
        ...
        if allow_custom is True:
            ...
            findings.append(Finding(
                ...
                remediation=(_c.remediation if _c else None) or "Disable custom app upload for regular users. Allow only for specific developer accounts via app setup policies.",
            ))
